let fabric,NoStatusError,NoTextError,BadRectangleError,BadTextBoxError,colorMap;_2e6‍.x([["Shape",()=>Shape]]);_2e6‍.w("fabric",[["fabric",["fabric"],function(v){fabric=v}]]);_2e6‍.w("../Errors/DataErrors",[["NoStatusError",["NoStatusError"],function(v){NoStatusError=v}],["NoTextError",["NoTextError"],function(v){NoTextError=v}],["BadRectangleError",["BadRectangleError"],function(v){BadRectangleError=v}],["BadTextBoxError",["BadTextBoxError"],function(v){BadTextBoxError=v}]]);_2e6‍.w("../Components/colorMap",[["colorMap",["colorMap"],function(v){colorMap=v}]]);
